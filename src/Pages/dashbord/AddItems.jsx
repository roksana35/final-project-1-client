...
//         <div>
//             <div>
//                 <ShareSection heading='Add an Item' subheading="what's new?"></ShareSection>
//             </div>
//             <div>
...
//   </div>
//   <input {...register('name',{require:true})} type="text" placeholder="Type here" className="input input-bordered w-full mb-4" />
...
//   </div>
//   <input {...register('price',{require:true})} type="number" placeholder="Type here" className="input input-bordered w-full mb-4" />
...
const onSubmit = async (data) => {
  try {
      ...
      // Ensure the image file is appended to a FormData object
